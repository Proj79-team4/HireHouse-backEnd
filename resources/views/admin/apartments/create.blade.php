                            ...
                            <div class="accordion-body">
                                @foreach ($services as $service)
                                    <div class="form-check form-check @error('services') is-invalid @enderror">
                                        ...
                                        <input
                                            class="form-check-input servicesCheck @error('services') is-invalid @enderror"
